  ...
  render() {
    return (
      <div className = 'bookingSystem' style={{"background-color":"white"}}>
        <h2 className = 'heading mdl-layout-title'>Booking</h2>
          ...
          <div className = "displayTicketSelection">
            ...
            <tr>
              <div className = 'reviewAndPayButton'>
                <button className="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">REVIEW & PAY</button>
              </div>
            </tr>
          </table>
=======
