...
export default class Footer extends React.Component{
  ...
  render(){
    return(
      <footer className="mdl-mini-footer mdl-color--black">
        <div className="mdl-mini-footer__left-section">
          <ul className="mdl-mini-footer__link-list">
            <li>
              <select className="mdl-textfield__input mdl-color--black mdl-color-text--white" value={this.state.value} onChange={this.handleFilmChange}>
            ...
            <li>
              <select className="mdl-textfield__input mdl-color--black mdl-color-text--white" value={this.state.location} onChange={this.handleLocationChange}>
            ...
            <li>
              <select className="mdl-textfield__input mdl-color--black mdl-color-text--white" value={this.state.date} onChange={this.handleDateChange}>
                <option className="mdl-textfield__input" value={this.state.date}>{this.state.date}</option>
              </select>
            </li>
            <li>
              <select className="mdl-textfield__input mdl-color--black mdl-color-text--white" value={this.state.time} onChange={this.handleTimeChange}>
