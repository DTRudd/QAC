      ...
      <header className="mdl-layout__header mdl-color--grey-900" id="menu">
        <nav className="mdl-layout__header-row mdl-layout--large-screen-only">
          ...
          <nav className="mdl-navigation">
            ...
            <span id="info-menu-lower-left" className="mdl-js-button mdl-navigation__link mdl-color-text--white">Information</span>
          ...
          <nav className="mdl-navigation">
            <span id="account_NavButton"><button className="mdl-button mdl-js-button mdl-button--raised mdl-button--accent mdl-color--pink-500" onClick={this.propagateAccounts.bind(this)}>Log in/Sign up</button></span> 
          </nav>
        </nav>
      </header>
    );
