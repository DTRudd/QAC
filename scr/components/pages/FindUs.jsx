  ...
  render() {
    return (
      <div style={{height: "100%", width: "100%"}}>
        ...
        <br />
        <h3 mdl-layout-title>Find your nearest QA Cinema</h3>
        <div className = 'cinema-selection'>
          <label>Select a cinema location...</label>
        </div>
        <div className="find-us-map">
          <select className="mdl-textfield__input" id="locationList"
            onChange = {this.getLocationInformation.bind(this)}>
            <option className="mdl-textfield__input" value = "0">Manchester</option>
            <option className="mdl-textfield__input" value = "1">Scarborough</option>
            <option className="mdl-textfield__input" value = "2">London</option>
            <option className="mdl-textfield__input" value = "3">Edinburgh</option>
          </select>
          <Map lat= {this.state.Lat} lng= {this.state.Lng} zoom="18"/>
        </div>
        <div className="find-us-text">
          <h3 className="mdl-layout-title">Driving:</h3>
            <div className="mdl-layout-content">
            ...
            <p>Public transport: The easiest way to find us via public transport is taking the train to Cleethropes train station, then taking the bus down the A1098 to the light railway.
